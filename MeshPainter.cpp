...
void MeshPainter::addMesh(TriMesh* mesh, const std::string& name, const std::string& texture_image, const std::string& vshader, const std::string& fshader, int type,glm::mat4 mat) {
    mesh_names.push_back(name);
    meshes.push_back(mesh);
    mesh_types.push_back(type);
    mesh_mats.push_back(mat);
...
void MeshPainter::replaceMesh(TriMesh* mesh, const std::string& name, const std::string& texture_image, const std::string& vshader, const std::string& fshader, int type,glm::mat4 mat) {
...
void MeshPainter::replaceMesh1(TriMesh* mesh, const std::string& name, const std::string& texture_image, const std::string& vshader, const std::string& fshader, int type, glm::mat4 mat) {
...
void MeshPainter::drawMeshes(Light* light, Camera* camera) {
    ...
    {
        drawMesh1(meshes[i], opengl_objects[i], light, camera, mesh_types[i],mesh_mats[i]);
    }
};
